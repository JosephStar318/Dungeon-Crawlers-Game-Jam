...
public class AudioManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        track1.loop = true;
        track2.loop = true;
        track1.outputAudioMixerGroup = AudioUtility.GetAudioGroup(AudioUtility.AudioGroups.Ambience);
        track2.outputAudioMixerGroup = AudioUtility.GetAudioGroup(AudioUtility.AudioGroups.Ambience);
